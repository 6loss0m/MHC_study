...
public class TheMusic {
    public String solution(String m, String[] musicinfos) {
        ...
        for (String musicInfo : musicinfos) {
            ...
            if (play > melodyInfo.length()) {
                ...
                // 나머지만큼 악보에서 잘라서 붙임
                newMelody.append(melodyInfo, 0, play % melodyInfo.length());
    ...
    public static void main(String[] args) {
        TheMusic tm = new TheMusic();
        System.out.println(tm.solution("ABCDEFG",new String[]{"12:00,12:14,HELLO,CDEFGAB", "13:00,13:05,WORLD,ABCDEF"}));
    }
}
